...
@objc class JSSAlertView: UIViewController {
    ...
    func successOneButton(viewController: UIViewController, title: String, text: String?=nil) -> JSSAlertViewResponder {
        return self.show(viewController, title: title, text: text, color: UIColorFromHex(0x9DA32E, alpha: 1))
    }
    
    func warningOneButton(viewController: UIViewController, title: String, text: String?=nil) -> JSSAlertViewResponder {
        return self.show(viewController, title: title, text: text, color: UIColorFromHex(0xDEAA12, alpha: 1))
    }
    ...
    func dangerOneButton(viewController: UIViewController, title: String, text: String?=nil) -> JSSAlertViewResponder {
        var alertview = self.show(viewController, title: title, text: text, color: UIColorFromHex(0xC3122E, alpha: 1))
        alertview.setTextTheme(.Light)
        return alertview
    }
    ...
    func danger(viewController: UIViewController, title: String, text: String?=nil, buttonText: String?=nil, cancelButtonText: String?=nil) -> JSSAlertViewResponder {
        var alertview = self.show(viewController, title: title, text: text, buttonText: buttonText, cancelButtonText: cancelButtonText, color: UIColorFromHex(0xC3122E, alpha: 1))
        alertview.setTextTheme(.Light)
        return alertview
    }
    ...
    func show(viewController: UIViewController, title: String, text: String?=nil, buttonText: String?=nil, cancelButtonText: String?=nil, color: UIColor?=nil, iconImage: UIImage?=nil) -> JSSAlertViewResponder {
        ...
        UIView.animateWithDuration(0.5, delay: 0.05, usingSpringWithDamping: 0.8, initialSpringVelocity: 0.5, options: UIViewAnimationOptions.CurveEaseInOut, animations: {
    ...
    func closeView(withCallback:Bool, source:ActionType = .Close) {
        UIView.animateWithDuration(0.3, delay: 0, usingSpringWithDamping: 0.7, initialSpringVelocity: 0.5, options: UIViewAnimationOptions.CurveEaseInOut, animations: {
